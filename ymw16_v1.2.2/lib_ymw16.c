...
double d_to_dm (double gl, double gb, double dordm)
{
  ...
  */
  ...
  //printf("my own test: %8.3f %8.3f %8.3f", gl, gb, dordm);	
...
*/
  ...
  for(i=1;i<=nk;i++){
    ...
    //printf("Distance in the Galaxy %8.3f \n", R_g);
    /* DM to Distance */
    /*    
    if(ndir==1){   	
      if(dmm<=dm){
...
*/
    ...
    if(ndir==2){
	  ...
	  thick(xx, yy, zz_w, &gd, &ne1, rr, t1);
         ...
         //printf ("Immidiate contribution: %8.3f %8.3f \n", ne6, hh);
	...
	//printf("TEST: basic integration: %8.3d %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f \n", i, dd, r, xx, yy, zz, rr, ne, ne1);
