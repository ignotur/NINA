...
c	real sl, cl, sb, cb
c
c	real d, dstep, dtest, dstep_pc, dd
c
c	real dm, dmstep
c	real sm_sum1, sm_sum2, sm_sum3, sm_sum4, sm_term
c       real sm_sum1_last, sm_sum2_last, sm_sum3_last, sm_sum4_last
c	integer nstep
c	integer ncount
c	integer i

c	real dm1, dm2, dma, dmgc, dmlism, dmcN, dmvN
c	real sm1, sm2, sma, smgc, smlism, smcN, smvN
c	real dsm1, dsm2, dsma, dsmgc, dsmlism, dsmcN, dsmvN
