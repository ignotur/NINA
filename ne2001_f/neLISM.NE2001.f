...
c	if(first) then					! read parameters for LISM
c	  open(11,file='nelism.inp',status='unknown')
c	  read(11,*)
c	  read(11,*) aldr,bldr,cldr
c	  read(11,*) xldr,yldr,zldr
c	  read(11,*) thetaldr,neldr0,Fldr
c
c	  read(11,*) alsb,blsb,clsb
c	  read(11,*) xlsb,ylsb,zlsb
c	  read(11,*) thetalsb,nelsb0,Flsb
c
c	  read(11,*) alhb,blhb,clhb
c	  read(11,*) xlhb,ylhb,zlhb
c	  read(11,*) thetalhb,nelhb0,Flhb
c
c	  read(11,*) xlpI,ylpI,zlpI
c	  read(11,*) rlpI,drlpI
c	  read(11,*) nelpI,dnelpI,FlpI,dFlpI
