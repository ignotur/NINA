...
c	   read(11,*)
c	   read(11,*) wg1, wg2, wga, wggc, wglism, wgcN, wgvN
c	   read(11,1020) n1h1,h1,A1,F1,n2,h2,A2,F2,
c     .          na,ha,wa,Aa,Fa,
...
c	data armmap/1, 3, 4, 2, 5/	! order to TC93 order, which is
					! from GC outwards toward Sun.
 	integer NNj(narms)
c	data NNj/20, 20, 20, 20, 20/
...
c        read(11,*)
c        do j=1,narms
c          read(11,*) aarm(j), rmin(j), thmin(j), extent(j)
